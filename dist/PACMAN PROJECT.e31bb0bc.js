...
var GameBoard = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GameBoard, [{
    ...
    } //  arrow function here cause of this binding
...
function gameOver(pacman, grid) {
  ...
  clearInterval(timer); // Showing startbutton
...
function gameLoop(pacman, ghosts) {
  //  Moving Pacman
  gameBoard.moveCharacter(pacman); // CHECKING COLLISON

  checkCollision(pacman, ghosts); // // CALLED IT TWO TIMES BECAUSE PACMAN AND GHOST DOES NOT MOVE IN SYNC

  ghosts.forEach(function (ghost) {
    return gameBoard.moveCharacter(ghost);
  });
  checkCollision(pacman, ghosts); // 5//CHECKING IF PACMAN EATS A DOT
  ...
  if (gameBoard.objectExist(pacman.pos, _setup.OBJECT_TYPE.DOT)) {
    ...
    score += 10;
  } // //CHECKING IF PACMAN EATS A POWERPILL
  ...
  } // CHANGING GHOST TO SCARE MODE BASED ON POWER PILL
...
//# sourceMappingURL=/PACMAN%20PROJECT.e31bb0bc.js.map